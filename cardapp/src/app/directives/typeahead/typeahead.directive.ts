...
import { ComponentLoader, ComponentLoaderFactory } from '../../../../node_modules/ngx-bootstrap/component-loader';
import {NgClass} from '@angular/common';
//tslint:disable

@Directive({selector: '[typeahead]', exportAs: 'waiv-typeahead'})
export class TypeaheadDirective implements OnInit, OnDestroy {
  ...
  /** Custom Input added by waiv. List of templates for custom headers. Order of the templates will define the order in which groups are displayed**/
  //TODO this currently takes in an a json array and turns it into a typescript map. There must be a better way to this. Or it might be easier to take in an array and just continue to use an array, rather than make it into a map
  @Input() public headerTemplateMap: {[key: string]: TemplateRef<any>};
 /**the class for the container of the drop down, use bootstrap col-classes, takes in input for [ngClass] */
  @Input() public containerClass:NgClass;
  ...
  public ngOnInit(): void {
    ...
    console.log(this.headerTemplateMap);
