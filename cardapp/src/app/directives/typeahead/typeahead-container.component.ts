...
//TODO this will break when we update ngx-bootstrap, need something more permant
import { isBs3 } from '../../../../node_modules/ngx-bootstrap/utils/ng2-bootstrap-config';
...
<template [ngTemplateOutlet]="optionsListTemplate || (isBs4 ? bs4Template : bs3Template)"
  [ngOutletContext]="{matches:matches, itemTemplate:itemTemplate, query:query,headerTemplateMap:headerTemplateMap,containerClass:containerClass}"></template>
...
<template #bs4Template >
  <div class="container" >
    <div class="row justify-content-center">
      <div [ngClass]="containerClass" class="dropdown">
      <template ngFor let-match let-i="index" [ngForOf]="matches">
         <ng-container *ngIf="match.isHeader()" [ngSwitch]="">
              <ng-container *ngIf="headerTemplateMap && headerTemplateMap[match];else standardHeader">
                  <template [ngTemplateOutlet]="headerTemplateMap[match.value]" [ngOutletContext]="{item:match.item, index:i, match:match, query:query}"></template>
              </ng-container>
...
export class TypeaheadContainerComponent {
  ...
  public get containerClass(): NgClass{
    return this.parent ? this.parent.containerClass : undefined;
  }

  public get headerTemplateMap() : any{
    return this.parent ? this.parent.headerTemplateMap : undefined;
  }
