export class MockPersonList {
    ...
    public personAttr1 = { '_type' : 'contacts',
                            '_isDeletable' : true,
                            '_headers' : ['Other accounts','Bank', 'Delete']};


  public personAttr2 = { '_type' : 'subordinates',
                          '_isDeletable' : false,
                          '_headers' : ['Linked account','Available']};

  public personAttr3 = { '_type' : 'payees',
                            '_isDeletable' : true,
    ...
    public personListFromServer = [
      ...
      {'name': 'Missouri', 'flag': '5/5a/Flag_of_Missouri.svg/46px-Flag_of_Missouri.svg.png', 'isDeletable' : true },
    ...
    public personListFromServer1 = [
        ...
        {'name': 'Idaho', 'flag': 'a/a4/Flag_of_Idaho.svg/38px-Flag_of_Idaho.svg.png', 'isDeletable' : true},
